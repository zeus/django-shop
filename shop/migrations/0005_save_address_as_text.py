...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('shop_order', 'billing_address', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Order.shipping_address'
        db.alter_column('shop_order', 'shipping_address', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Order.billing_address'
        db.alter_column('shop_order', 'billing_address', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Order.shipping_address'
        db.alter_column('shop_order', 'shipping_address', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
